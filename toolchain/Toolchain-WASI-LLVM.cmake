...
if("$ENV{TRACECC_PGO_PROFILE}" STREQUAL "")
  message(FATAL_ERROR "TRACECC_PGO_PROFILE is required for the frozen v9r2 build")
endif()
if("$ENV{TRACECC_PGO_LIST}" STREQUAL "")
  message(FATAL_ERROR "TRACECC_PGO_LIST is required for the frozen v9r2 build")
endif()
